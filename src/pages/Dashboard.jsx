  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 min-h-[calc(100vh-60px)]">
      <div className="bg-white border border-gray-200 rounded-2xl shadow p-8 w-full max-w-xl flex flex-col items-center">
        <h1 className="text-3xl font-bold text-[#0366d6] mb-3">
        ...
        <div className="flex gap-4">
          <Link
            to="/documents"
            className="flex items-center gap-2 px-5 py-2 rounded bg-[#0366d6] text-white font-semibold hover:bg-blue-700 shadow"
          >
            <Folder size={20} /> Documents
          </Link>
          {/* <Link
            to="/shared"
            className="flex items-center gap-2 px-5 py-2 rounded bg-[#e5f1fb] text-[#0366d6] font-semibold hover:bg-[#cce6fa] shadow"
          >
